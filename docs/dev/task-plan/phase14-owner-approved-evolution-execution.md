...
soul candidate -> Nex.Agent.Capability.Tool.Core.SoulUpdate.execute/2
skill candidate -> Nex.Agent.Capability.Tool.Core.SkillCreate.execute/2 or existing skill create/import lane
