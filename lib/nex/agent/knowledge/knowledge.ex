defmodule Nex.Agent.Knowledge do
  ...
  defp normalize_capture_payload("web_page", attrs, opts) do
    ...
    fetch_fun = Keyword.get(opts, :fetch_fun, fn page_url -> fetch_web_page(page_url, opts) end)
  ...
  defp fetch_web_page(url, opts) do
    ctx = %{workspace: Workspace.root(opts)}

    case execute_tool("web_fetch", %{"url" => url}, ctx) do
