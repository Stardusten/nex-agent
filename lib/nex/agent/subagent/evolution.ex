defmodule Nex.Agent.SubAgent.Evolution do
  ...
  defp query_recent_metrics(module, window) do
    # Query Memory for performance data
    Memory.search(%{
      type: :subagent_performance,
      module: module,
  ...
  defp parse_window("1d"), do: DateTime.add(DateTime.utc_now(), -86400)
  defp parse_window("7d"), do: DateTime.add(DateTime.utc_now(), -604800)
  defp parse_window("30d"), do: DateTime.add(DateTime.utc_now(), -2592000)
  defp parse_window(_), do: DateTime.add(DateTime.utc_now(), -604800)
end
