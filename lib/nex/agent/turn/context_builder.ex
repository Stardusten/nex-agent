defmodule Nex.Agent.Turn.ContextBuilder do
  @moduledoc """
  ...
  alias Nex.Agent.{Runtime.Config, Turn.ContextDiagnostics, Capability.Skills, Runtime.Workspace}
  alias Nex.Agent.Interface.Media.Projector
  ...
  @spec build_messages(
          ...
          String.t() | nil,
          String.t() | nil,
          [Nex.Agent.Interface.Media.Attachment.t()] | nil,
          keyword()
        ) :: [message()]
  def build_messages(
        history,
