defmodule Nex.Agent.Runtime.Workspace do
  @moduledoc false
  ...
  @spec plugins_dir(keyword()) :: String.t()
  def plugins_dir(opts \\ []), do: dir("plugins", opts)
  ...
  @spec workbench_dir(keyword()) :: String.t()
  def workbench_dir(opts \\ []), do: dir("workbench", opts)
