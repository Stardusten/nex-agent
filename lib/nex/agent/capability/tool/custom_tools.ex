defmodule Nex.Agent.Capability.Tool.CustomTools do
  @moduledoc """
  ...
  defp validate_loaded_tool(module, expected_name) do
    ...
    cond do
      not declares_tool_behaviour?(module) ->
        {:error, "Tool module must declare @behaviour Nex.Agent.Capability.Tool.Behaviour"}
  ...
  defp declares_tool_behaviour?(module) do
    ...
    Nex.Agent.Capability.Tool.Behaviour in behaviours
  end
