defmodule Nex.Agent.LLM.Providers.Helpers do
  @moduledoc false
  ...
  @spec map_model_spec(Nex.Agent.LLM.ProviderProfile.t(), String.t()) :: map()
  def map_model_spec(profile, model) do
    %{id: model, provider: profile.resolved_provider, base_url: profile.base_url}
  end

  @spec default_model_spec(Nex.Agent.LLM.ProviderProfile.t(), String.t()) :: String.t() | map()
