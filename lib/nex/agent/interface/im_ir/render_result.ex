defmodule Nex.Agent.Interface.IMIR.RenderResult do
  @moduledoc false
  ...
  @spec from_block(Nex.Agent.Interface.IMIR.Block.t(), keyword()) :: t()
  def from_block(%Nex.Agent.Interface.IMIR.Block{} = block, opts \\ []) do
    %__MODULE__{
